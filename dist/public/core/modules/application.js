...
export class Application {
    constructor(settings) {
        ...
        this.events = new ApplicationEvents(__classPrivateFieldGet(this, _Application_client, "f"));
        this.slash = new ApplicationSlash(__classPrivateFieldGet(this, _Application_client, "f"));
