...
var _InputButton_label, _InputButton_id, _InputButton_emoji, _InputButton_style, _InputButton_i_perms;
...
export class InputButton {
    constructor(style) {
        ...
        _InputButton_i_perms.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _InputButton_i_perms, null, "f");
    }
    /**
     * label
    label : string     */
...
emoji : string     */
    ...
    interactionPermission(permissions) {
        __classPrivateFieldSet(this, _InputButton_i_perms, permissions, "f");
        return this;
    }
}
_InputButton_label = new WeakMap(), _InputButton_id = new WeakMap(), _InputButton_emoji = new WeakMap(), _InputButton_style = new WeakMap(), _InputButton_i_perms = new WeakMap();
