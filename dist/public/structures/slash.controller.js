...
export class SlashController {
    ...
    async deployGlobal(commands) {
        if (__classPrivateFieldGet(this, _SlashController_client, "f") == null) {
        ...
        for (const command of commands) {
            __classPrivateFieldGet(this, _SlashController_client, "f").application.commands.create(command.data.toJSON());
        }
    }
    /**
